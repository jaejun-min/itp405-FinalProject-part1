      ...
      <form method="post">
       {{ csrf_field() }}
        <div class="form-group">
          <input type="hidden" id="studentId" name="studentId" value="{{$student->student_id}}">
        ...
        <div class="form-group">
          ...
          <input type="number" id="grad_year" name="grad_year" class="form-control" value="{{$student->grad_year}}">
          ...
          <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="college" class="form-control" id="collegeSelect">
                  <option value="{{$init_college->college_id}}">{{$init_college->name}}</option>
            ...
            <div class="form-group {{ ($errors->has('name'))?'has-error':'' }}">
              <label for="major">Major </label>
                <select  name="major" class="form-control" id="majorSelect">
                  <option value="{{$init_major->major_id}}">{{$init_major->name}}</option>
                </select>
            </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="intro" name="intro" value="{{$student->intro}}" rows="3"></textarea>
